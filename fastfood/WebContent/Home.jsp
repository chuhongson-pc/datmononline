...
<div id="slideShow">
	<div class="neoslideshow">
		<img src="images/promotion/banner01.jpg"> 
		<img src="images/promotion/banner02.jpg"> 
		<img src="images/promotion/banner03.jpg"> 
		<img src="images/promotion/banner04.jpg">
		<img src="images/promotion/banner06.jpg">
		<img src="images/promotion/banner01.jpg"> 
		<img src="images/promotion/banner02.jpg"> 
		<img src="images/promotion/banner03.jpg"> 
		<img src="images/promotion/banner04.jpg">
...
<div id="slideProducts">
	<div id="title">SẢN PHẨM BÁN CHẢY NHẤT HÔM NAY</div>
	<div class="als-container" id="demo1">
		...
		<div class="als-viewport">
			<ul class="als-wrapper">
				...
				%>
				<li class="als-item">
					<p id="tenSanPham"><%=topSanPhamRandom.get(i).getTenSanPham()%> </p>
					<a href="XemThongTinSanPhamServlet?id=<%=topSanPhamRandom.get(i).getIdSanPham()%>">
					<img title="<%=topSanPhamRandom.get(i).getTenSanPham()%>" src="images/products/<%=topSanPhamRandom.get(i).getHinhAnh()%>"></a>
					<p id="giaBan"><%=topSanPhamRandom.get(i).getGiaBan()%> VNĐ </p>
				</li>
				<%
					}
				%>
