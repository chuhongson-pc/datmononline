...
public class TrangChuBanHangServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (idDanhMuc == null)
			idDanhMuc = "";
		ArrayList<SANPHAM> topSanPhamRandom = cn.getTopSanPhamRandom(30);
		ArrayList<SANPHAM> topSanPhamBanChay = cn.getDanhSachBanChay(30);
		ArrayList<SANPHAM> topSanPhamMoiNhat = cn.getTopSanPhamMoi(30);
